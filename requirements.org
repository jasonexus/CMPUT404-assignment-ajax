...
** Requirements
   ...
   - [ ] Client MUST NOT use POST to query the /world
   - [ ] GET /world must return the world
   - [ ] You can use the observer pattern
   - [ ] Must use 1 new Canvas feature for drawing.
   - [ ] Must use PUT to change individual objects within the world
   - [ ] UI must include clear button and it must clear for
         both clients
...
=======
         (so http://127.0.0.1:5000/static/index.html MUST work and http://localhost:5000/static/index.html MUST work)
>>>>>>> For-2022
...
=======
   ...
   - 2 marks for being usable in the browser (0 for no synch)
   - 1 mark for looking better than what I gave you (0 for not being usable in the browser)
